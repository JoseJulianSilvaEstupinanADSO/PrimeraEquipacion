<%-- 
    Document   : ventas_vendedor
    Created on : 6/07/2024, 6:47:54 p. m.
    Author     : Julian
--%>
            ...
            <aside class="menu">
                ...
                <ul class="menu__lista">
                    ...
                    <li class="menu__item menu__item--selec">
                        <a href="ventas_vendedor.jsp" class="menu__link menu__link--selec" ><span class="icono__span"><i class="fa-solid fa-cart-shopping"></i></span>Ventas</a>
                    </li>
                    <li class="menu__item">
                        <a href="../facturas/factura_usuario.jsp" class="menu__link" ><span class="icono__span"><i class="fa-solid fa-file-invoice"></i></span>Facturas</a>
                    </li>
                </ul>
                    ...
                    <form action="" class="form__datos" novalidate>
                        <div class="buscar">
                            ...
                            <div class="id__cliente">
                                <input type="text" id="cdCliente" class="codigo__cliente login__input documento" placeholder="Codigo Cliente">
                            ...
                            <div class="id__cliente">
                                <div>
                                    <input type="text" id="cdProducto" class="codigo__cliente login__input" placeholder="Codigo Producto" required>
                                ...
                                <div class="datos__producto">
                                    ...
                                    <input placeholder="Cantidad" type="text" id="cant_produc" class="codigo__cliente cliente__nombre " required>
                                </div>
                            </div>
                            <div class="id__cliente">
