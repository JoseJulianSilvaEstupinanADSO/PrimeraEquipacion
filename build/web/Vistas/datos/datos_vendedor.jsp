<%-- 
    Document   : datos_vendedor
    Created on : 6/07/2024, 10:47:51 p. m.
    Author     : Julian
--%>
      ...
      <section class="menu">
        ...
        <ul class="menu__lista">
          ...
          <li class="menu__item menu__item--selec">
              <a href="datos_vendedor.jsp" class="menu__link menu__link--selec"><span class="icono__span"><i class="fa-solid fa-user-gear"></i></span>Mis Datos</a>
          </li>
          <li class="menu__item">
