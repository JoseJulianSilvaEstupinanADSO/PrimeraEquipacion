<%-- 
    Document   : inventario_usuario
    Created on : 6/07/2024, 6:50:00 p. m.
    Author     : Julian
--%>
            ...
            <aside class="menu">
                ...
                <ul class="menu__lista">
                    ...
                    <li class="menu__item menu__item--selec">
                        <a href="inventario_usuario.jsp" class="menu__link menu__link--selec" ><span class="icono__span"><i class="fa-solid fa-boxes-stacked"></i></span>Inventario</a>
                    </li>
                </ul>
